...
- Dependency Injection: Verwende Koin (Koin Kotlin & KMP) als DI‑Framework. Lege Koin‑Module im `shared` Modul an und registriere platform‑spezifische Implementierungen in den jeweiligen sourceSets.

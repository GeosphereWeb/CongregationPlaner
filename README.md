...
* [/shared](./shared/src) is for code that will be shared across your Compose Multiplatform applications.
  ...
  - [commonMain](./shared/src/commonMain/kotlin) is for code that’s common for all supported targets.
  - Other folders are for Kotlin code compiled only for the platform indicated in the folder name.
    For example, if you want to use Apple’s CoreCrypto for the iOS part of your Kotlin app,
    the [iosMain](./shared/src/iosMain/kotlin) folder is the right place.
